...
const SecurityResponse: React.FC = () => {
  const [securityRules, setSecurityRules] = useState<SecurityRule[]>([]);
  const [responses, setResponses] = useState<SecurityResponseData[]>([]);
  ...
  const generateMockResponses = useCallback((): SecurityResponseData[] => {
    const rules = generateMockRules();
    const responses: SecurityResponseData[] = [];
